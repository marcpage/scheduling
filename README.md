...
Wouldn't it be great as a schedule manager or general manager if you could have a system that takes employee input, your input and automatically creates schedules for each week?
